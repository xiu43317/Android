...
public class PlaceActivity extends Activity {
	...
	public static String KEY_OPENING = "OPENING";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!isInternetPresent) {
			...
			alert.showAlertDialog(PlaceActivity.this, "Internet Connection Error",
		...
		if (gps.canGetLocation()) {
			...
			alert.showAlertDialog(PlaceActivity.this, "GPS Status",
						...
						if (nearPlaces.results != null) {
							...
							for (Place p : nearPlaces.results) {
								...
								if(sLat != 0 && sLng !=0 && dLat != 0 && dLng != 0  ){
									...
									Location.distanceBetween(sLat, sLng, dLat, dLng, result);
									int a = (int)(result[0]);
...
//								IF(p.op)
							...
							// list adapter
							ListAdapter adapter = new SimpleAdapter(PlaceActivity.this, placesListItems,
					                R.layout.list_item,
					                new String[] { KEY_REFERENCE, KEY_NAME,KEY_DISTANCE}, new int[] {
					                        R.id.reference, R.id.name,R.id.rating});
