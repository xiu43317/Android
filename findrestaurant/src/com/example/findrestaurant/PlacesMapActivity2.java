...
public class PlacesMapActivity2 extends Activity {
...
//		placeText = (EditText) findViewById(R.id.placeText);
		...
		Bundle position = PlacesMapActivity2.this.getIntent().getExtras();
		...
		btnFind.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Bundle location = PlacesMapActivity2.this.getIntent().getExtras();
